      ...
      <div className="min-h-screen w-full font-roboto">
        <div className="px-6">
          ...
          <div className="mt-44 flex flex-col items-center">
            ...
            <p className="text-center max-w-lg lg:px-16">Customize sua experiência com o iPhone 16 na cor perfeita para você!</p>
          ...
          <h2 className="text-2xl font-bold text-[#393636] text-center">Inovação Sem Limites, Explore o Novo MacBook!</h2>
            ...
            <p className="text-[#393636] text-center mt-2 max-w-xl sm:px-14">O MacBook Air M4 é o mais recente lançamento da Apple, com tela Retina de 13,6", chip M4 e desempenho sem precedentes.</p>
