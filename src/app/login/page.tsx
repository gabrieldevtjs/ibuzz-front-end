...
<div className="w-full px-3 flex flex-col lg:flex-row h-screen font-roboto">
  <div className="w-full h-full flex flex-col justify-start lg:px-4 gap-16 lg:w-1/3 border-2">
   
    <h1 className="text-4xl font-bold font-roboto text-[#393636] ml-4 mt-4">Ibuzz</h1>
